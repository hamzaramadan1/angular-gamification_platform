...
export class HangmanDisplayComponent implements OnInit, OnChanges {
  ...
  checkGuess(letter: string) {
    ...
    // if (this.success) {
    //   this.score += 100; // User guessed the word right, award 1000 points
    // } else {
    //   this.score =+ 0; // User didn't guess the word right, no points awarded
    // }

    // this.cumulativeScore += this.score; // Add the score to the cumulative score
